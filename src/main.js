...
btnDelete.addEventListener('click', function(){  //delete contents of the created file
  let file = path.join(pathName, fileName.value)
...
btnUpdate.addEventListener('click', function(){  //update contents of the created file
  let file = path.join(pathName, fileName.value)
